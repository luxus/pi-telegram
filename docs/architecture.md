...
- Telegram voice settings, provider selection, transcription, speech preparation, synthesis, and Telegram voice-note delivery helpers in `/lib/voice.ts`, with runtime port binding and prompt-turn enrichment in `/lib/voice-runtime.ts`
